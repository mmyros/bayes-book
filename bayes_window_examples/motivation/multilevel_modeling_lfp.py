...
# + [markdown] hideCode=true hidePrompt=true slideshow={"slide_type": "skip"}
...
# + [markdown] hideCode=true hidePrompt=true pycharm={"name": "#%% md\n"} slideshow={"slide_type": "skip"}
# First, we import the data from a local file, and extract data.

# + hideCode=true hidePrompt=true pycharm={"is_executing": false} slideshow={"slide_type": "skip"} tags=["hide-input"]
# HIDE CODE
...
# + hideCode=true hidePrompt=true pycharm={"is_executing": false, "name": "#%%\n"} slideshow={"slide_type": "skip"} tags=["hide-input"]
# HIDE CODE
...
# + hideCode=true hidePrompt=true pycharm={"name": "#%%\n"} slideshow={"slide_type": "skip"} tags=["hide-input"]
# HIDE CODE
...
# + hideCode=true hidePrompt=true pycharm={"is_executing": false, "name": "#%%\n"} slideshow={"slide_type": "fragment"} tags=["hide-input"]
# HIDE CODE
...
# + hideCode=true hidePrompt=true slideshow={"slide_type": "skip"} tags=["hide-input"]
# HIDE CODE
...
# + hideCode=true hidePrompt=true pycharm={"name": "#%%\n"} slideshow={"slide_type": "slide"} tags=["hide-input"]
# HIDE CODE
...
# + hideCode=true hidePrompt=true slideshow={"slide_type": "subslide"} tags=["hide-input"]
# HIDE CODE
...
# + hideCode=true hidePrompt=true slideshow={"slide_type": "slide"} tags=["hide-input"]
# HIDE CODE
